...
namespace FunWithStrings
{
    class Program
    {
        ...
        static void BasicStringFunctionality()
        {
            ...
            Console.WriteLine("firstName in lowercaser: {0}", firstName.ToLower());
        ...
        static void EscapeChars()
        {
            ...
            string strWithTabs = "Moderl\tColor\tSpeed\tPetName\a ";
            Console.WriteLine(strWithTabs);
            Console.WriteLine("Everyone loves \"Hello World\"\a");
            Console.WriteLine("C:\\MyApp\\bin\\Debug\a ");

            //Adds a total of b4 blank lines(then beep again!).
        ...
        static void StringInterpolation()
        {
            ...
            string greetin2 = $"Hello {name} you are {age} years old.";
            ...
            string greetings6 = $"\tHello {name.ToUpper()} you are {age} years old.";
        }
