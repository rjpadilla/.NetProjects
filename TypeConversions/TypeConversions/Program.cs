...
namespace TypeConversions
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Exp;icitly cast the int into a short (and allow loss of data).
        ...
        static void NarrowingAttempt()
        {
            ...
            //Explicityly cast the int into a byte (no loss of data).
            myByte = (byte)myInt;
            Console.WriteLine("Value ofmyByte: {0}", myByte);
        }
